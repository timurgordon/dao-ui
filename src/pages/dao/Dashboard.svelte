...
<main class="flex-1 relative pb-8 z-0 overflow-y-auto">
  ...
  <div class="mt-8">
    <div class="flex flex-col lg:flex-row w-full">
      <div class="bg-white overflow-hidden sm:rounded-lg lg:pr-8">
        ...
        <div class="px-4 py-5 sm:px-6">
          <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
            <div class="sm:col-span-1">
              ...
              <dd class="mt-1 text-sm leading-5 text-gray-900">OurWorld DAO</dd>
            </div>
            <div class="sm:col-span-1">
              <dt class="text-sm leading-5 font-medium text-gray-500">
                Governance Model
            ...
            <div class="sm:col-span-1">
              ...
              <dd class="mt-1 text-sm leading-5 text-gray-900">ourworld.tf</dd>
            </div>
            <div class="sm:col-span-1">
              <dt class="text-sm leading-5 font-medium text-gray-500">
                Governance Token price
              </dt>
              <dd class="mt-1 text-sm leading-5 text-gray-900">$120,000</dd>
            </div>
      ...
      <div class="flex flex-col w-full">
        <h3 class="text-lg mt-6 mb-2 leading-6 font-medium text-gray-900">
          Recent Proposals
        </h3>
        <ProposalCard />
        <ProposalCard />
    ...
    <div class="mt-6 px-4 py-5 border-b border-gray-200 sm:px-6">
      <h3 class="text-lg leading-6 font-medium text-gray-900">
        Recent Activity
      </h3>
    </div>
    <div
      class="pb-5 mb-6 space-y-3 sm:space-y-4 sm:pb-0 max-w-6xl mx-auto mt-4 px-4 text-lg leading-6 font-medium text-cool-gray-900 sm:px-6 lg:px-8"
    >
      <div />
    </div>
