  ...
  >
    <div class="flex-1 flex">
      <form class="w-full flex md:ml-0" action="#" method="GET">
        ...
        <div
          class="relative w-full text-cool-gray-400 focus-within:text-cool-gray-600 py-2"
        >
          <div
          ...
          <input
            id="search_field"
            class="block w-full h-full pl-12 pr-3 py-2 rounded-md text-cool-gray-900 placeholder-cool-gray-500 focus:outline-none focus:placeholder-cool-gray-400 sm:text-sm"
            placeholder="Search"
            type="search"
          />
        </div>
